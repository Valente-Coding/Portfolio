...
function DisplayProject(p_index) {
    ...
    document.getElementsByClassName("BackgroundVideo")[0].src = "https://media.valente-coding.com/media/valente-coding/valente-coding.github.io/main/" + l_project.ProjectVideo;
